...
class _TeacherDashboardPageState extends State<TeacherDashboardPage> {
      ...
      _announcements = [
        {
          ...
          'content':
              'The midterm examination will be held on November 15-20, 2024.',
          'date': 'Oct 25, 2024',
          'color': 'blue',
          'isNew': true,
          'views': 42,
        },
        {
          ...
          'content':
              'Join us for the annual Science Fair on November 10, 2024.',
          'date': 'Oct 24, 2024',
          'color': 'green',
          'isNew': true,
          'views': 38,
        },
        {
          ...
          'content': 'Classes will be suspended from October 28 to November 3.',
          'date': 'Oct 20, 2024',
          'color': 'orange',
          'isNew': false,
          'views': 42,
  ...
  Future<void> _createAttendanceRecord() async {
    ...
    if (existingIndex != -1) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Attendance record already exists for this date'),
        ),
      );
      return;
    }
              ...
              children: [
                ...
                Expanded(
                  child: _attendanceRecords.isEmpty
                      ? const Center(
                          child: Text(
                            'No attendance records yet. Create one!',
    ...
    return Drawer(
      child: Column(
        children: [
          ...
          _drawerItem(Icons.assessment_outlined, 'Attendance Report', 8),
          const Spacer(),
          const Divider(),
          ListTile(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _sidebarItem(Icons.assessment_outlined, 'Attendance Report', 8),
          const Spacer(),
          const Divider(),
          ListTile(
            leading: const Icon(Icons.logout, color: Colors.red),
  ...
  Widget _buildContent() {
    switch (_selectedIndex) {
      ...
      case 8:
        return _buildAttendanceSummaryReport();
      default:
        return _buildOverview();
    }
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        final exists = _attendanceRecords.any(
                          (r) => r['date'] == todayKey,
                        );
                        if (!exists) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _activityItem(
            'Pending Submissions',
            '${_getPendingSubmissionsCount()} to review',
            'Now',
            Colors.orange,
          ),
          const Divider(),
  ...
  Widget _assignmentCard(Map<String, dynamic> assignment) {
    ...
    final pendingForThis = _submissions
        .where((s) => s['assignment_id'] == id && s['status'] == 'Pending')
        .length;
    return Container(
  ...
  Widget _lessonPlanCard(Map<String, dynamic> material) {
    ...
    final String date =
        material['date'] ?? DateTime.now().toString().split(' ')[0];
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () =>
                      _showMaterialDetails(title, subject, date, id),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Center(
              child: Text(
                'Worksheets feature coming soon...',
                style: TextStyle(color: Colors.grey),
              ),
            ),
          ),
  ...
  Map<String, dynamic> _generateAttendanceSummary() {
      ...
      if (studentAttendance.containsKey(studentName)) {
        if (status == 'Present') {
          studentAttendance[studentName]!['present'] =
              studentAttendance[studentName]!['present']! + 1;
        } else if (status == 'Late') {
          studentAttendance[studentName]!['late'] =
              studentAttendance[studentName]!['late']! + 1;
        } else {
          studentAttendance[studentName]!['absent'] =
              studentAttendance[studentName]!['absent']! + 1;
        }
      }
    }

    int totalPresent = 0, totalLate = 0, totalAbsent = 0;
    for (var attendance in studentAttendance.values) {
    ...
    return {
      ...
      'totalDays': totalPresent + totalLate + totalAbsent,
    };
  }

  Widget _buildAttendanceSummaryReport() {
    final summary = _generateAttendanceSummary();
    final studentAttendance =
        summary['studentAttendance'] as Map<String, dynamic>;
      ...
      child: Column(
        ...
        children: [
                ...
                Row(
                  ...
                  children: [
                    Column(
                      children: [
                        Text(
                          (summary['totalPresent'] as int).toString(),
                          style: const TextStyle(
                            fontSize: 28,
                            fontWeight: FontWeight.bold,
                            color: Colors.green,
                    ...
                    Column(
                      children: [
                        Text(
                          (summary['totalLate'] as int).toString(),
                          style: const TextStyle(
                            fontSize: 28,
                            fontWeight: FontWeight.bold,
                            color: Colors.orange,
                    ...
                    Column(
                      children: [
                        Text(
                          (summary['totalAbsent'] as int).toString(),
                          style: const TextStyle(
                            fontSize: 28,
                            fontWeight: FontWeight.bold,
                            color: Colors.red,
          ...
          ...studentAttendance.entries.map((entry) {
            ...
            final total =
                (attendance['present'] as int) +
                (attendance['late'] as int) +
                (attendance['absent'] as int);
            final percentage = total > 0
                ? ((attendance['present'] as int) / total * 100)
                      .toStringAsFixed(1)
                : '0.0';
