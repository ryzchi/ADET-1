...
class _StudentDashboardPageState extends State<StudentDashboardPage> {
  ...
  Future<void> _loadStudentQuizAttempts() async {
    ...
    setState(() {
      _quizAttempts = (attemptsJson != null)
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _attendanceStat('Present', present.toString(), Colors.green),
              ),
              Expanded(
        ...
        children: [
          ...
          if (available.isEmpty)
            ...
            ...available.map((quiz) {
              ...
              final scoreText = completed ? '${attempt['score_correct']}/${attempt['score_total']}' : null;
              return Padding(
          ...
          if (completed.isEmpty)
            ...
            ...completed.map((quiz) {
              ...
              final scoreText = '${attempt['score_correct']}/${attempt['score_total']}';
              return Padding(
                padding: const EdgeInsets.only(bottom: 12),
                child: _quizCard(
                  quiz['title']?.toString() ?? 'Quiz',
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: isNew ? color.withValues(alpha: 0.3) : const Color(0xFFE2E8F0),
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Future<void> _pickFile() async {
    try {
      ...
      if (result != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('No file selected'), duration: Duration(seconds: 1)),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(widget.assignmentTitle, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                      decoration: BoxDecoration(color: Colors.blue.shade50, borderRadius: BorderRadius.circular(4)),
                      child: Text('ID: ${widget.assignmentId}', style: TextStyle(color: Colors.blue.shade700, fontSize: 12)),
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_selectedFileName != null) ...[
                      const SizedBox(height: 8),
                      Text('✓ File ready for upload', style: TextStyle(color: Colors.green.shade600, fontSize: 12)),
                    ],
                    const SizedBox(height: 8),
                    Text(
                ...
                onPressed: _isSubmitting
                    ...
                    : () async {
                        if (_commentController.text.trim().isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Please add a comment or note')));
                          return;
                        }
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isApproved ? Colors.green.withValues(alpha: 0.1) : isPending ? Colors.orange.withValues(alpha: 0.1) : Colors.red.withValues(alpha: 0.1),
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                submission['status'],
